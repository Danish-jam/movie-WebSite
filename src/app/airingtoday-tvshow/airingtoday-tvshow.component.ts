...
@Component({
  selector: 'app-airingtoday-tvshow',
  templateUrl: './airingtoday-tvshow.component.html',
  styleUrls: ['./airingtoday-tvshow.component.css']
})
export class AiringtodayTvshowComponent {
  ...
  loadAiringTodayTvShows(): void {
    this.apiService.getAiringTodayTV('tv', this.page).subscribe((res) => {
      this.airingTodaytvShows = [...this.airingTodaytvShows, ...res.results];
      console.log(res);
