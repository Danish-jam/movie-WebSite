...
@Component({
  selector: 'app-all-trending-movies',
  templateUrl: './all-trending-movies.component.html',
  styleUrls: ['./all-trending-movies.component.css']
})
export class AllTrendingMoviesComponent implements OnInit {
  trendingMovies: any[] = [];
  page: number = 1
  loading = true;
